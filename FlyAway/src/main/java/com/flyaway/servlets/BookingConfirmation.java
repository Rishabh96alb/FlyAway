...
public class BookingConfirmation extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			bookingDao.insert(fid, crdnum, expdate, cvv, passDetails, payAmt, noofpersons, dateoftravel,
					currentDateTime);
		} catch (Exception e) {
			e.printStackTrace();
		}
		...
		pw.println(
				"<br><br><center>Thank you for choosing FlyAway as your trusted travel partner. Excited to serve u again!!</center>");
		pw.println("<html><body>");
