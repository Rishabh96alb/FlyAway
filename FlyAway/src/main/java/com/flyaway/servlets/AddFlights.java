...
public class AddFlights extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		pw.println("  </select><br>" + "	 <label for=\"price\">Enter Price:</label><br>\r\n"
		...
		pw.println("  </select><br>" + "<label for=\"destination\">Select Destination</label><br>\r\n");
		...
		pw.println(" </select><br>" + "  <input type=\"submit\" value=\"Add Flight\">\r\n"
				+ "<br><a href=\"ShowFlights\">Show Flights</a>" + "<br><a href=\"Welcome.jsp\">Go Home</a>"
				+ "</body>\r\n" + "</html>");
